...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/08 22:59:44 by joamonte          #+#    #+#             */
/*   Updated: 2024/12/08 23:00:22 by joamonte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Server::Server(std::map<std::string, std::string> &configs, std::vector<Server> const &servers)
{
...
void Server::_checkKeywords(std::map<std::string, std::string> &configs)
{
...
std::string Server::_generateErrorResponse()
{
	if (this->_errorPage.empty())
	{
		...
		return generateResponseWithCustomHTML("404 Not Found", "Page not found", body);
	}
